...
class ThreadReception(threading.Thread):
    ...
    def __init__(self, conn):
        ...
        ref_socket[0] = conn
        self.connexion = conn  # reference du socket de connexion
...
class fen2:
    def __init__(self,master):
        ...
        #Fenetre avec les quatre boutons de réponses
        ...
        # Fenetre d'affichage des questions
